...
async function player2() {
    ...
    if (answers.guessno === player1) {
        console.log(chalk.greenBright(`Player1 guess ${player1} and you guess ${answers.guessno}, so you win the game!`));
    }
    else {
        console.log(chalk.redBright(`Player1 guess ${player1} and you guess ${answers.guessno}, so you lose the game!`));
    }
}
await player2();
